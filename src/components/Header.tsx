...
export default function Header() {
  ...
  return (
    <div className='absolute h-16 w-screen'>
      <header
          ...
          <nav className='invisible sm:visible'>
            <ul className='flex gap-6'>
              <li className='flex h-8 items-center p-2 transition duration-500 hover:font-bold'>
                <a class='text-surfaceText hover:text-black' href='/'>
                  技術ブログ
                </a>
              </li>
              <li className='flex h-8 items-center p-2 transition duration-500 hover:font-bold'>
                <a class='text-surfaceText hover:text-black' href='/photo'>
                  写真集
                </a>
              </li>
            </ul>
      ...
      {isOpenMenu ? (
        <div className='fixed top-0 mt-[60px] h-full w-full bg-white'>
          <ul class='pt-8'>
            <HeaderMenuItem
              svg={
                <svg
...
export function HeaderMenuItem({ svg, text, link }: Props) {
  return (
    <li className='my-4 ml-5 flex items-center'>
      {svg}
      <a
        className='ml-3 text-lg text-surfaceText duration-75 ease-in hover:font-bold hover:text-black'
        href={`/${link}`}
      >
        {text}
      </a>
